...
namespace DP._20160404.IO
{
	...
	/// </summary>
	public class IntegerInputReader : IIntegerInputReader
	{
		/// <summary>
		...
		public int ReadInteger(TextReader input, string message = null, TextWriter output = null)
		{
			...
			while (!int.TryParse(strInput, out number))
			{
				if (!string.IsNullOrWhiteSpace(message) && output != null)
